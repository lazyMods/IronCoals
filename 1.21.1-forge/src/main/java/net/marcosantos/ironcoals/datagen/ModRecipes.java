...
public class ModRecipes extends RecipeProvider {
	...
	private void coals_to_block(RegistryObject<Item> coal, RegistryObject<BlockItem> block, RecipeOutput consumer) {
	...
	private void block_to_coals(RegistryObject<BlockItem> block, RegistryObject<Item> coal, RecipeOutput consumer) {
	...
	private void chunk_to_coal(RegistryObject<Item> chunk, RegistryObject<Item> coal, RecipeOutput consumer) {
	...
	private void coal_to_chunk(RegistryObject<Item> coal, RegistryObject<Item> chunk, RecipeOutput consumer) {
