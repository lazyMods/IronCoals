...
public void appendHoverText(ItemStack stack, Level level, List<Component> tooltip, TooltipFlag  flagIn) {
	tooltip.add(Component.translatable("message.diamondcoal" , Double.toString(CoalHelper.CoalMultiplier(Config.DIAMOND_COAL_BURN.get()))).withStyle(ChatFormatting.AQUA));
}
}
