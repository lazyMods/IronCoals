...
public void appendHoverText(ItemStack stack, Level level, List<Component> tooltip, TooltipFlag flagIn) {
	tooltip.add(Component.translatable("message.goldcoalchunk" , Double.toString(CoalHelper.CoalMultiplier(Config.GOLD_COAL_BURN.get()/8))).withStyle(ChatFormatting.GOLD));
}
}
