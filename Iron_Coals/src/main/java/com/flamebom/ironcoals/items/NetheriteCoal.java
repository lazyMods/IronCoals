...
public class NetheriteCoal extends Item {
	...
	public MutableComponent getName(ItemStack stack) {
		return new TranslatableComponent(this.getDescriptionId(stack)).withStyle(ChatFormatting.DARK_GRAY);
	}
	@Override
...
public void appendHoverText(ItemStack stack, Level level, List<Component> tooltip, TooltipFlag  flagIn) {
	tooltip.add(new TranslatableComponent("message.emeraldcoal" ,  Double.toString(CoalHelper.CoalMultiplier(Config.NETHERITE_COAL_BURN.get()))).withStyle(ChatFormatting.DARK_GRAY));;
}
}