...
public class LootTables extends LootTableProvider {
    ...
    public void run(HashCache cache) {
        ...
        tables.put(Registration.DIAMONDCOALBLOCK.get().getLootTable(), createStandardTable("diamond_coal_block", Registration.DIAMONDCOALBLOCK.get()).setParamSet(LootContextParamSets.BLOCK).build());
        tables.put(Registration.EMERALDCOALBLOCK.get().getLootTable(), createStandardTable("emerald_coal_block", Registration.EMERALDCOALBLOCK.get()).setParamSet(LootContextParamSets.BLOCK).build());
    ...
    protected LootTable.Builder createStandardTable(String name, Block block) {
        LootPool.Builder builder = LootPool.lootPool()
                ...
                .add(LootItem.lootTableItem(block)
                        ...
                        .apply(SetContainerContents.setContents(null)
