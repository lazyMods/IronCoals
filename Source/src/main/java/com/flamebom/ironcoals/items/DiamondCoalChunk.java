...
public void appendHoverText(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
	tooltip.add(new TranslationTextComponent("message.diamondcoalchunk" , Double.toString(CoalHelper.CoalMultiplier(Config.DIAMOND_COAL_BURN.get()/8))).withStyle(TextFormatting.AQUA));
}
}
